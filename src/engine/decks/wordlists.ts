...
export const WORD_LISTS: WordList[] = [
  {
    ...
    emoji: "🌱",
    entries: [
      { word: "a", clue: "Would you like _ cookie?" },
  ...
  },
  {
    ...
    name: "Next steps",
    group: "Ages 5–6",
    blurb: "Colors, numbers and the words that hold a sentence together.",
    emoji: "🚗",
    entries: [
  ...
  },
  {
    ...
    entries: [
      ...
      { word: "any", clue: "Are there _ cookies left?" },
      ...
      { word: "them", clue: "Give the candy to _." },
  ...
  },
  {
    ...
    entries: [
      ...
      { word: "these", clue: "I like _ cookies." },
      ...
      { word: "work", clue: "Mom has gone to _." },
  ...
  },
  {
    ...
    entries: [
      ...
      { word: "song", clue: "She sang my favorite _." },
      ...
      { word: "toy", clue: "My favorite _ is a train." },
